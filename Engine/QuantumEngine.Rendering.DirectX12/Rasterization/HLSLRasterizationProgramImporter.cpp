...
ref<QuantumEngine::Rendering::ShaderProgram> QuantumEngine::Rendering::DX12::Rasterization::HLSLRasterizationProgramImporter::ImportShader(const std::wstring& hlslFile, const HLSLRasterizationProgramImportDesc& properties, std::string& error)
{
