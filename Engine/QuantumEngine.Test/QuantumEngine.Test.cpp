                     ...
                     _In_ int       nCmdShow)
{
    ...
    assetManager->UploadMeshToGPU(model->GetMesh("Cube.002"));
    ...
    auto entity3 = std::make_shared<QuantumEngine::GameEntity>(transform3, model->GetMesh("Cube.002"), material3, rtMaterial3);
